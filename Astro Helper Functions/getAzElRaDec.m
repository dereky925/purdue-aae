function [az,h,ra,dec,ra_geo,dec_geo] = getAzElRaDec(JD,station_position_eci,satellite_position_eci)

% Inputs
% JD
% station_position_eci [m]
% satellite_position_eci [m]
...
ra_geo = sat_r_ascen_geoc';

dec_geo = sat_decl_geoc';
